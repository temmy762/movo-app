...
export default function CookieBanner() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto px-5 py-5">
          ...
          <p className="text-[12px] text-gray-500 leading-relaxed mb-4">
            MOVO uses cookies to keep you signed in, remember your preferences, and improve
            your experience. You control what we store.{" "}
            <button
              type="button"
              onClick={openPreferences}
              className="underline text-[#2D0A53] font-medium"
            >
              Learn more
            </button>
          </p>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={openPreferences}
              className="flex-1 min-w-[120px] py-2.5 rounded-xl border border-gray-200 text-[#2D0A53] font-semibold text-[12px]"
            >
              Manage Preferences
            </button>
          </div>
      ...
      {/* ── Preferences modal (triggered from banner) ── */}
      {showPreferences && (
