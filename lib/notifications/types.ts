...
export type NotificationEventType =
  ...
  | "RIDER_RIDE_UNAVAILABLE_REFUNDED"
  ...
  | "CHAUFFEUR_TOPUP_NOTIFICATION"
  | "CHAUFFEUR_RENTAL_APPROVED"
  | "CHAUFFEUR_RENTAL_DECLINED"
  | "CHAUFFEUR_CARE_PICKUP_READY"
  | "CHAUFFEUR_CARE_SUPPORT_EN_ROUTE"
  // Admin events
