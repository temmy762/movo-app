...
const DEFAULT_CHANNELS: Record<NotificationEventType, NotificationType[]> = {
  ...
  RIDER_BOOKING_CONFIRMED: ["EMAIL", "IN_APP", "SMS"],
  RIDER_BOOKING_UPDATED: ["EMAIL", "IN_APP", "SMS"],
  RIDER_DRIVER_ASSIGNED: ["EMAIL", "IN_APP", "SMS"],
  RIDER_RIDE_COMPLETED: ["EMAIL", "IN_APP", "SMS"],
  RIDER_PAYMENT_RECEIPT: ["EMAIL"],
  RIDER_INCIDENT_SUBMITTED: ["EMAIL", "IN_APP"],
  RIDER_INCIDENT_RESOLVED: ["EMAIL", "IN_APP"],
  RIDER_RIDE_UNAVAILABLE_REFUNDED: ["EMAIL", "IN_APP", "SMS"],
  RIDER_BOOKING_CANCELLED: ["EMAIL", "IN_APP"],
  ...
  CHAUFFEUR_BOOKING_ASSIGNED: ["EMAIL", "IN_APP", "SMS"],
  CHAUFFEUR_BOOKING_CANCELLED: ["EMAIL", "IN_APP", "SMS"],
  ...
  CHAUFFEUR_CARE_SUPPORT_EN_ROUTE: ["IN_APP"],
  ...
  ADMIN_CARE_SUPPORT_STRANDED: ["IN_APP", "SMS"],
  ADMIN_RIDE_DISPATCH_FAILED: ["EMAIL", "IN_APP", "SMS"],
  ADMIN_RENTAL_REQUEST: ["IN_APP"],
  ADMIN_RENTAL_RETURN_REQUESTED: ["IN_APP"],
