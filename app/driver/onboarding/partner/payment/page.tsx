    ...
    <div className="h-full bg-white flex flex-col" style={{ fontFamily: "var(--font-poppins)" }}>
      <div className="flex-1 overflow-y-auto flex flex-col items-center">
        <div className="w-full max-w-[480px] px-6">
          ...
          {/* Section heading */}
          <p className="text-[15px] font-bold text-gray-900 mb-2">Partner Details</p>
          ...
          <div className="mb-6">
            <p className="text-[12px] text-gray-500 mb-1">
              <span className="text-red-400 mr-0.5">*</span>Preferred Payment Method
            </p>
            <div className="relative" suppressHydrationWarning>
              <select
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-[13px] text-gray-600 focus:outline-none appearance-none bg-white"
          ...
          <div className="flex gap-3 mb-8">
            ...
            <button
              type="button"
              onClick={() => router.push("/driver/onboarding/partner/summary")}
