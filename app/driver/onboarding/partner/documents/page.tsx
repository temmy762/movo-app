        ...
        <div className="w-full max-w-[480px] px-6">
          ...
          >
            ...
            <svg width="72" height="72" viewBox="0 0 96 96" fill="none">
              ...
              <polyline points="65,72 72,65 79,72" fill="none" stroke="#131936" strokeWidth="2.5" strokeLinecap="round" />
              <line x1="72" y1="65" x2="72" y2="80" stroke="#131936" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
            ...
            <ul className="mb-4 space-y-1">
              {uploaded.map((name, i) => (
                <li key={i} className="flex items-center gap-2 text-[12px] text-gray-600">
                  <span className="w-2 h-2 rounded-full shrink-0" style={{ background: "linear-gradient(135deg,#131936,#C6BFB2)" }} />
                  {name}
                </li>
              ))}
            </ul>
