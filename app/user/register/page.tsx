...
const OAUTH_ERRORS: Record<string, string> = {
  oauth_config:          "Social sign-up is not configured. Please contact support.",
  ...
  google_no_email:       "Your Google account did not share an email address. Please register with email instead.",
      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="px-8 mt-3 space-y-1.5">
          ...
          <div className="flex justify-center gap-6 pb-1">
            <button type="button" onClick={() => { window.location.href = "/api/auth/google?intent=signup"; }} className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center shadow-sm">
          ...
          <p className="text-center text-[12px] text-gray-500 pb-6 sm:pb-3">
            ...
            <Link href="/user/login" className="font-bold text-gray-900">Log In</Link>
          </p>
        </div>
      </div>
    </div>
